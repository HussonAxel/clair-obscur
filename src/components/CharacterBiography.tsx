...
export default function CharacterBiography({characterName, characterPortrait, characterBiography, characterWeapon, characterStats, characterStartingSkills}: CharacterBiographyProps) {
  return (
    <article className="flex flex-row gap-16 text-white/80 w-3/4 m-auto my-32">
      <img src={characterPortrait} alt={characterName} className="w-2/5 h-auto" />
      <div>
        <div>
